...
@Component({
    templateUrl: './helpCategory.table.component.html',
    styles: [`
...
export class HelpCategoryTableComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.helpCategoryService.getAll().then(o => {
            this.objects = o;
            this.loaded = true;
        });
    }

    view(helpCategory: HelpCategory) {
        this.router.navigate(['/HelpCategory', helpCategory.id]);
    }

    delete(helpCategory: HelpCategory) {

        this.helpCategoryService.delete(helpCategory.id.toString()).then(l =>
            this.helpCategoryService.getAll().then(o => {
                this.objects = o;
            }));
    }
    ...
    addClick($event) {
        this.router.navigate(['/HelpCategory', 'new']);
    }
    ...
    exportExcel(tableData) {
        import('xlsx').then(xlsx => {
            ...
            this.saveAsExcelFile(excelBuffer, 'helpCategorys');
        });
    }
