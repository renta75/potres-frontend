...
@Component({
    templateUrl: './helpFields.table.component.html',
    styles: [`
...
export class HelpFieldsTableComponent implements OnInit {
    ...
    constructor(
        ...
        this.breadcrumbService.setItems([
            { label: 'HelpFieldss', routerLink: ['/HelpFields'] }
        ]);
    }
    ...
    ngOnInit() {
        ...
        this.helpFieldsService.getAll().then(o => {
            this.objects = o;
            this.loaded = true;
        });
    }

    view(helpFields: HelpFields) {
        this.router.navigate(['/HelpFields', helpFields.id]);
    }

    delete(helpFields: HelpFields) {

        this.helpFieldsService.delete(helpFields.id.toString()).then(l =>
            this.helpFieldsService.getAll().then(o => {
                this.objects = o;
            }));
    }
    ...
    addClick($event) {
        this.router.navigate(['/HelpFields', 'new']);
    }
    ...
    exportExcel(tableData) {
        import('xlsx').then(xlsx => {
            ...
            this.saveAsExcelFile(excelBuffer, 'helpFieldss');
        });
    }
